import { Container, ContainerCards,
  PetsIcon, RestForm, 
  FormStyles, AloneInput,
} from "./styles";
    ...
    <Container>
      ...
      <FormStyles onSubmit={handleSubmit(onSubmit)}>
        ...
        <PetsIcon>
          ...
          <label>
            <input defaultChecked {...register("type")} type="radio" value="Selecionar"/>
          </label>
        ...
        <RestForm>
          <Select name="state" register={register} label="Estado" options={["Selecionar", "Paraná", "Sc", "Am", "Es"]}/>
          <AloneInput {...register("city")} placeholder="Cidade" />

          <Select name="gender" register={register} label="Gênero" options={["Selecionar", "Female", "Male"]} />
          <Select name="size"label="Tamanho" register={register} options={["Selecionar", "Small", "Medium", "Big"]} />
